...
const resolveDots = (
  ...
  Children.forEach(children, (child) => {
    ...
    // The `child.type === Dot/ActiveDot` checks narrow the element to one of
    // our own components, so its props are DotProps — but React's element
    // typings can't express that, so we assert it.
    if (child.type === Dot) {
